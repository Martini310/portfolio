...
const project = {
  title: "BillWise",
  live: "https://billwise-two.vercel.app/",
  github: "https://github.com/Martini310/billwise",
  images: [
    "/billwise/1.png",
    "/billwise/2.png",
    "/billwise/3.png",
  ...
  tech: [
    "Python", "Django", "Django REST Framework", "Next.js", "React", "Material UI", "PostgreSQL", "Docker", "Celery", "RabbitMQ", "Redis", "Axios"
  ],
  description: `BillWise is my most advanced fullstack project, built with Django REST Framework, Next.js, and Celery. It helps you manage payments from different suppliers in one place, with a complex dashboard, statistics, and charts.`,
  features: [
    "Synchronize payments from major Polish platforms (PGNiG, Enea, Aquanet)",
    "Unified dashboard with overall view, statistics, and charts",
    "Yearly and monthly summaries with comparisons",
    "Add and manage invoices manually",
    "Invoice details in modal windows",
    "Background worker for scheduled data fetching",
    "Google authentication",
    "Email notifications",
    "(Planned) Real-time notifications, payments from app, more suppliers, dark mode"
  ]
};

export default function BillwiseProjectPage() {
    ...
    <div className="relative min-h-screen text-white font-sans overflow-x-hidden bg-[#0a1020] pb-16">
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          >
            <div className="relative max-w-3xl w-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
              ...
              <Image
                ...
                alt={project.title + " large image " + (lightbox + 1)}
                width={900}
                height={600}
        ...
        <div className="flex gap-4 mb-8">
          <Link href={project.live} target="_blank" className="inline-block px-6 py-3 rounded-full bg-gradient-to-r from-blue-500 to-violet-500 text-white font-semibold shadow-lg hover:scale-105 transition-transform">
            Live Demo
          </Link>
