...
const project = {
  ...
  description: `Python Kivy App to calculate the cost of a car trip based on fuel prices in your neighbourhood. Shows trip cost, time, distance, fuel price, weather, and a map overview.`,
  tech: [
    "Python 3.10.5",
    "Kivy 2.1.0",
    "Dotenv 0.21.0",
